...
/**
 * 文件名：FundingCommentLvAdapter
 * 描  述：筹款详情的评论列表的适配器
 * 作  者：Yaozhong
 * 时  间：
 */

public class FundingCommentLvAdapter extends BaseAdapter {
    private Context context;

    private final String[] myDataset;
    private final int[] myDataset2;

    public FundingCommentLvAdapter(Context context, String[] myDataset, int[] myDataset2) {
