...
import com.yiqixue.club.event.EventParticipantsGvAdapter;
/**
 * 文件名：VolunteerParticipantsActivity
 * 描  述：招募详情的参与用户界面
 * 作  者：Yaozhong
 * 时  间：
 */
public class VolunteerParticipantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volunteer_participants);
        setUpToolbar();//Toolbar

        //设置参与用户的网格列表
        GridView mParticipantsPhotoGv = (GridView )findViewById(R.id.gv_participants_photo);
        mParticipantsPhotoGv.setAdapter(new VolunteerParticipantsGvAdapter(this, myDataset, participantsPhotos));
