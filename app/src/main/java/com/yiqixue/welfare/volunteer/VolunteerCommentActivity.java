...
public class VolunteerCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置评论列表
        ListView mVolunteerCommentLv = (ListView)findViewById(R.id.lv_volunteer_comment);
        mVolunteerCommentLv.setAdapter(new VolunteerCommentLvAdapter(this, myDataset,myDataset2));
