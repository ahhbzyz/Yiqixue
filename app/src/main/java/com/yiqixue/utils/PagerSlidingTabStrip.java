...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //+x  调整indicator 宽度
        canvas.drawRect(lineLeft + getResources().getDimension(R.dimen.indicator_margin) , height - indicatorHeight, lineRight-getResources().getDimension(R.dimen.indicator_margin) , height, rectPaint);
