...
/**
 * 文件名：TeacherCommentLvAdapter
 * 描  述：老师信息详情页中的评论列表的适配器
 * 作  者：Yaozhong
 * 时  间：
 */

public class TeacherCommentLvAdapter extends BaseAdapter {
    private Context context;

    private final String[] myDataset;
    private final int[] myDataset2;

    public TeacherCommentLvAdapter(Context context, String[] myDataset, int[] myDataset2) {
